...
public class ResourceManager {
    ...
    */
    public ResourceManager(GraphicsConfiguration gc, int type) {
        this.gc = gc;
        this.typeofp = type;
        loadTileImages();
        loadCreatureSprites(typeofp);
        loadPowerUpSprites();
    }
    ...
    */
    ...
    public static void addSprite(TileMap map,
        Sprite hostSprite, int tileX, int tileY) // CHANGED FROM PRIVATE TO PUBLIC
    {
        if (hostSprite != null) {
            ...
            sprite.setY(
                ...
                sprite.getHeight()- 10) ; //eddited - 10
           
            // add it to the map
            map.addSprite(sprite);
            if (sprite instanceof Bullet) {
            	
            	sprite.setstart(tileX);
            }
        }
    }
    ...
    public void loadCreatureSprites(int tipo) {
        ...
        if(tipo == 1){
        //change to mike
        System.out.println("Mikey out of all");
        images[0] = new Image[] {
            loadImage("mike_idle.png"),
            //loadImage("mike_fire.png"),
        	...
        	//change to igal pictures
        	 System.out.println("igal out of all");
            images[0] = new Image[] {
                    loadImage("igal_idle.png"),
                    //loadImage("igal_fire.png"),
                    //loadImage("player3.png"),
                    //loadImage("fly1.png"),
                    //loadImage("fly2.png"),
                    //loadImage("fly3.png"),
    ...
    private void loadPowerUpSprites() {
        ...
        anim = new Animation();
        anim.addFrame(loadImage("bullet.png"), 150);
