        ...
        int screenWidth, int screenHeight)
    {
        ...
        while (i.hasNext()) {
                ...
                x >= 0 && x < screenWidth)
            {
            	...
            	if (start_time + System.currentTimeMillis() - prev_time > 1000)
            	{
            		 ((Creature)sprite).wakeUp();
            		// ResourceManager.addSprite(map,ResourceManager.bulletSprite,TileMapRenderer.pixelsToTiles(((Creature)sprite).getX() - 2),TileMapRenderer.pixelsToTiles(((Creature)sprite).getY()));
            		 
            	}
            	else {
            		
            		start_time += System.currentTimeMillis() - prev_time;
            		prev_time = System.currentTimeMillis();
            	}
